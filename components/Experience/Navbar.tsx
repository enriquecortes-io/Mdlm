        ...
        <div style={{ position:"relative", justifySelf:"end", display:"flex", alignItems:"center", gap:"1rem" }}>
          {showSocial && (
            <div style={{ display:"flex", alignItems:"center", gap:"0.8rem" }}>
              <a href="https://www.instagram.com/theeditmarbella/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color:"#2D4A3E", display:"flex" }}>
              ...
              <a href="https://www.linkedin.com/company/130454848/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={{ color:"#2D4A3E", display:"flex" }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
